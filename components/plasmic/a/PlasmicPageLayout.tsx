...
import sty from "./PlasmicPageLayout.module.css"; // plasmic-import: KRXENhi0HHJx/css

import IconIcon from "./icons/PlasmicIcon__Icon"; // plasmic-import: QJSCgw0e9zdo/icon
import Icon2Icon from "./icons/PlasmicIcon__Icon2"; // plasmic-import: i342nj2VwMNd/icon
...
function PlasmicPageLayout__RenderFunc(props: {
  ...
  return (
    <RichLayout
      ...
      logoElement={
        <Icon2Icon
          className={classNames(projectcss.all, sty.svg__tGeh3)}
          role={"img"}
        />
      }
      navMenuItems={(() => {
    ...
    >
      <LoadingBoundary
        ...
        loadingState={
          <DataCtxReader__>
            {$ctx => (
              <div className={classNames(projectcss.all, sty.freeBox__ygMs)}>
                <IconIcon
                  className={classNames(projectcss.all, sty.svg___1IbY)}
                  role={"img"}
                />
              </div>
            )}
      ...
      >
        <DataCtxReader__>
          {$ctx => (
            <div className={classNames(projectcss.all, sty.freeBox__s22As)}>
              {renderPlasmicSlot({
                defaultContents: (
                  <section
                    className={classNames(projectcss.all, sty.section___58Tqs)}
                  >
                    <h1
                      className={classNames(
                        projectcss.all,
