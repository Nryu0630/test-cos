...
// Plasmic Project: suBgMg6p8DhQAi7isio5B9
// Component: yIcPW0Cte_d6
...
import projectcss from "./plasmic.module.css"; // plasmic-import: suBgMg6p8DhQAi7isio5B9/projectcss
import sty from "./PlasmicPageLayout.module.css"; // plasmic-import: yIcPW0Cte_d6/css

import IconIcon from "./icons/PlasmicIcon__Icon"; // plasmic-import: u_d0FfqMX4bo/icon
import Icon2Icon from "./icons/PlasmicIcon__Icon2"; // plasmic-import: miiiGzxHg-hn/icon
...
function PlasmicPageLayout__RenderFunc(props: {
  ...
  return (
    <RichLayout
      ...
      logoElement={
        <Icon2Icon
          className={classNames(projectcss.all, sty.svg__lqjwZ)}
          role={"img"}
        />
      }
      navMenuItems={(() => {
    ...
    >
      <LoadingBoundary
        ...
        loadingState={
          <DataCtxReader__>
            {$ctx => (
              <div className={classNames(projectcss.all, sty.freeBox__bIgWg)}>
                <IconIcon
                  className={classNames(projectcss.all, sty.svg___0EFkE)}
                  role={"img"}
                />
              </div>
            )}
      ...
      >
        <DataCtxReader__>
          {$ctx => (
            <div className={classNames(projectcss.all, sty.freeBox__m3JJn)}>
              {renderPlasmicSlot({
                defaultContents: (
                  <section
                    className={classNames(projectcss.all, sty.section__q5AHx)}
                  >
                    <h1
                      className={classNames(
                        projectcss.all,
